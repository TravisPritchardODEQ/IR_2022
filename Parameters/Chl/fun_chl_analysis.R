...
WS_category <- WS_3mo %>%
  ...
  mutate(IR_category = case_when(num_excur_3mo_avg >= 1 ~ "5",
         ...
         Rationale =  case_when(num_excur_3mo_avg >= 1 ~ paste0(MLocID, ": ", num_excur_3mo_avg, " 3-month averages exceed critertia: ", 
                                                                excur_3mo_avg_months, ": ", 
                                                                total_n, " total samples"),
                                num_monthly_excur > critical_excursions_month ~ paste0(MLocID, ": ", 
...
other_category <- other_3mo %>%
  ...
  Rationale =  case_when(num_excur_3mo_avg >= 1 ~ paste0(num_excur_3mo_avg, " 3-month averages exceed critertia: ", 
                                                         excur_3mo_avg_months, ": ", 
                                                         total_n, " total samples"),
                         num_monthly_excur > critical_excursions_month ~ paste0(num_monthly_excur, " month averages exceed criteria: ",
                                                                                monthly_excur_month, ": ", 
                                                                                total_n, " total samples") ,
